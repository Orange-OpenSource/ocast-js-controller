...
exports.sendMessage = function (message, namespace, resolve) {
    namespace = (namespace !== undefined) ? namespace : constants.OCAST_NAMESPACE;
    var ws_url = constants.WEBSOCKET_PROTOCOL + constants.DONGLE_IPADDRESS + ':' + constants.WEBSOCKET_PORT + constants.WEBSOCKET_PATH;
...
exports.sendOCastMessage = function (message, resolve) {
    this.sendMessage(message, constants.OCAST_NAMESPACE, resolve);
};

exports.prepare = function (url, mediaType, resolve) {
    this.sendOCastMessage({
        name: "prepare",
        params: {
            url: url,
            mediaType: mediaType,
...
exports.track = function (type, trackId, bOnOff, resolve) {
    this.sendOCastMessage({
        name: "track", params: { type: type, trackId: trackId, enabled: JSON.parse(bOnOff) },
        options: null
    }, resolve);
};
...
exports.listen = function (resolve) {
    var ws_url;
    ws_url = constants.WEBSOCKET_PROTOCOL + constants.DONGLE_IPADDRESS + ':' + constants.WEBSOCKET_PORT + constants.WEBSOCKET_PATH;
